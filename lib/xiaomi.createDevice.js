...
module.exports = function createDevice(device) {
    ...
    switch (device.model) {
        ...
        case 'switch':
            newDevice = {
                device: {
                    name: 'Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
        ...
        case 'motion_sensor':
            newDevice = {
                device: {
                    name: 'Motion sensor', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
        ...
        case 'temp_sensor':
            newDevice = {
                device: {
                    name: 'Temperature sensor', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
        ...
        case 'cube':
            newDevice = {
                device: {
                    name: 'Cube', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'Weather sensor', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
                    { identifier: 'temperature', type: 'temperature', unit: '°C', min: -100, max: 100, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'Magnet', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'Motion sensor Aqara', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
                    { identifier: 'motion', type: 'status', min: 0, max: 1, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'Plug', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'leak', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'smoke', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'vibration', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true },
            ...
            newDevice = {
                device: {
                    name: 'Single Wired Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Duplex Wired Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Single Wired Switch Neutral', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Duplex Wired Switch Neutral', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Duplex Wireless Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { name:'Button 1', identifier: 'Channel_0', type: 'binary', min: -1, max: 1, sensor: false },
                    { name: 'Button 2', identifier: 'Channel_1', type: 'binary', min: -1, max: 1, sensor: false },
            ...
            newDevice = {
                device: {
                    name: 'Single Wireless Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi-home'
                },
                types: [
                    { name:'Button 1', identifier: 'Channel_0', type: 'binary', min: -1, max: 1, sensor: false },
                    { identifier: 'battery', type: 'battery', unit: '%', min: 0, max: 100, sensor: true }
    ...
    if (newDevice) {
        ...
        // *********DEBUG START*******************
        if (shared.debug === 4) sails.log('Xiaomi createDevice.newDevice :', newDevice)
        // *********DEBUG END*******************
        ...
        gladys.device.create(newDevice)
            .then((data) => {
                ...
                // *********DEBUG START*******************
                if (shared.debug === 4) sails.log('Xiaomi createDevice.gladys :', data.device.name + ', id :' + data.device.identifier)
                // *********DEBUG END*******************
