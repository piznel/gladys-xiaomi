...
module.exports = function createDevice(device) {
    ...
    switch (device.model) {
        ...
        case 'cube':
            ...
            newDevice = {
                device: {
                    name: 'Single Wired Switch Neutral', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Duplex Wired Switch Neutral', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi'
                },
                types: [
