...
module.exports = function createDevice(device) {
    ...
    switch (device.model) {
        ...
        case 'cube':
            ...
            newDevice = {
                device: {
                    name: 'Single_Wired_Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Duplex_Wired_Switch', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Single_Wired_Switch_LN', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi'
                },
                types: [
            ...
            newDevice = {
                device: {
                    name: 'Duplex_Wired_Switch_LN', identifier: device.sid, protocol: 'zigbee', service: 'xiaomi'
                },
                types: [
